...
export const TimelineItem = ({
  ...
  return (
    <TimelineItemWrapper>
      ...
      <TimelineItemEmojiWrapper>{emoji}</TimelineItemEmojiWrapper>

      <TimelineItemColumn>
        <TimelineItemTitle>{title}</TimelineItemTitle>
        <TimelineItemDescription data-is-dim={!hasChildren}>{description}</TimelineItemDescription>

        {hasChildren && <TimelineItemEntries>{children}</TimelineItemEntries>}
      </TimelineItemColumn>
    </TimelineItemWrapper>
  );
};
